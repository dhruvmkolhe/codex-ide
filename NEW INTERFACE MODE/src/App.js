...
function App() {
  ...
  const handleRun = useCallback(async () => {
    ...
    const url = isDirectKey ? '/api/v1/run' : 'https://onecompiler-apis.p.rapidapi.com/api/v1/run';
        ...
        <aside id="assistant-panel" className="right-section" aria-label="AI assistant">
          ...
          />
            ...
            <div className="chat-output-area">
              <div className="chat-response" dangerouslySetInnerHTML={sanitizeMarkdown(renderMarkdown(chatResponse).__html)} />
            </div>
            {assistantSuggestion && (
          ...
          <div className="explanation-section">
            ...
            <div className="explanation-content" dangerouslySetInnerHTML={sanitizeMarkdown(renderMarkdown(codeExplanation).__html)} />
          </div>
        </aside>
      </main>
